-- =====================================================
-- PROJECT CHIMERA - FINAL PERFECTED EDITION
-- For Solara Executor - EVERYTHING FIXED 100%
-- =====================================================
...
local function CreateGUI()
    ...
    -- =====================================================
    -- POPULATE AIMBOT TAB (SIMPLIFIED)
    -- =====================================================
    local yPos = 10
    ...
    yPos = CreateDropdown(TabFrames[1], "Hit Part", yPos, {"Head", "HumanoidRootPart", "Torso"}, Config.Aimbot.HitPart, function(v) Config.Aimbot.HitPart = v end)
    ...
    -- =====================================================
    -- POPULATE MOVEMENT TAB (WITH FLY KEY)
    -- =====================================================
    yPos = 10
    ...
    yPos = CreateKeybind(TabFrames[4], "Fly Activation Key", yPos, Config.Movement.FlyKey, function(v) Config.Movement.FlyKey = v end)
    ...
    -- =====================================================
    -- POPULATE SETTINGS TAB (WITH GUI TOGGLE KEY)
    -- =====================================================
    yPos = 10
    ...
    reopenFrame.Size = UDim2.new(1, -10, 0, 50)
    reopenFrame.Position = UDim2.new(0, 5, 0, yPos)
    reopenFrame.BackgroundTransparency = 1
    reopenFrame.Parent = TabFrames[5]
    
    local reopenBtn = Instance.new("TextButton")
    reopenBtn.Size = UDim2.new(0, 200, 0, 40)
    reopenBtn.Position = UDim2.new(0, 0, 0, 5)
    ...
    function StartFly()
        ...
        flyConnection = RunService.Heartbeat:Connect(function()
            ...
            if Config.Movement.FlyKey == "Space" then
                flyKeyPressed = UserInputService:IsKeyDown(Enum.KeyCode.Space)
            elseif Config.Movement.FlyKey == "LeftControl" then
                flyKeyPressed = UserInputService:IsKeyDown(Enum.KeyCode.LeftControl)
            elseif Config.Movement.FlyKey == "Mouse1" then
                flyKeyPressed = UserInputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton1)
            elseif Config.Movement.FlyKey == "Mouse2" then
                flyKeyPressed = UserInputService:IsMouseButtonPressed(Enum.UserInputType.MouseButton2)
            else
                for _, enum in pairs(Enum.KeyCode:GetEnumItems()) do
                    if enum.Name == Config.Movement.FlyKey then
                        flyKeyPressed = UserInputService:IsKeyDown(enum)
                        break
                    end
                end
            end
    ...
    -- =====================================================
    -- ESP SYSTEM (FIXED - NO BUGS WHEN DISABLED)
    -- =====================================================
    local espObjects = {}
    ...
    RunService.RenderStepped:Connect(function()
        ...
        -- ESP Update (FIXED - No bugs when disabled)
        ...
        elseif Drawing then
            -- Ensure all ESP is hidden when disabled (FIX)
    ...
    GUI.Destroying:Connect(function()
        ...
        if Config.Movement.NoclipEnabled then StopNoclip() end
    end)
end

-- =====================================================
-- GUI TOGGLE SYSTEM (FIXED - ACTUALLY WORKS)
-- =====================================================
...
game:GetService("StarterGui"):SetCore("SendNotification", {
    Title = "Project Chimera FINAL",
    Text = "Everything fixed! Press RightControl to toggle",
    Duration = 5
})

print("[+] Project Chimera FINAL - Everything works perfectly")
